...
from .graficos import gerar_grafico # Apenas para Debug
...
def responder_com_mcp(instruction: str):
    ...
    messages = [
        {
            "role": "system",
            "content": "Você é um assistente que interage com o usuário e pode executar funções de gerenciamento de alunos, disciplinas e geração de gráficos. Sempre que o usuário solicitar a criação, visualização ou plotagem de um gráfico, utilize a função 'gerar_grafico' para gerar a imagem do gráfico."
        },
        {
            "role": "user", 
            "content": instruction
    ...
    tool_events = []
    chart = None # Será usado para armazenar a imagem do gráfico, caso seja gerado.
        ...
        for tool_call in assistant_message.tool_calls:
            ...
            try:
                ...
                if function_name == "gerar_grafico":
                    ...
                    print(f"[DEBUG] Resultado gerar_grafico: {result}...")
